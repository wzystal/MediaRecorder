...
public class RecorderEnv {
	public static final float MAX_RECORD_TIME = 8000f;
	public static final float MIN_RECORD_TIME = 2000f;
	...
	//public static int videoCodec = avcodec.AV_CODEC_ID_H264;
	public final static int VIDEO_CODEC = avcodec.AV_CODEC_ID_MPEG4;
	public final static int VIDEO_FRAME_RATE = 15;
	//public static int videoBitrate = 500 *1000;
	public final static int VIDEO_QUALITY = 12;
	public final static int AUDIO_CODEC = AAC_SUPPORTED ? avcodec.AV_CODEC_ID_AAC : avcodec.AV_CODEC_ID_AMR_NB;
	public final static int AUDIO_CHANNEL = 1;
	public final static int AUDIO_BIT_RATE = 96000;//192000;//AAC_SUPPORTED ? 96000 : 12200; 
